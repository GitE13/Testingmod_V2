package net.elisa.testingmod.sound;
...
public class ModSounds {
    ...
    public static final RegistryKey<JukeboxSong> BAR_BRAWL_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG,Identifier.of(Testingmod.MOD_ID,"bar_brawl"));
    ...
    public static void RegisterSounds(){
        Testingmod.LOGGER.info("Registering Mod Sounds for "+Testingmod.MOD_ID);
    }
}
