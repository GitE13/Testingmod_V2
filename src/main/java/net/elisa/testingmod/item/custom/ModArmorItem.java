            ...
            (new ImmutableMap.Builder<ArmorMaterial, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.PINK_GARNET_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 40, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.SPEED, 40, 1, false, false),
                                    new StatusEffectInstance(StatusEffects.REGENERATION, 40, 0, false, false),
                                    new StatusEffectInstance(StatusEffects.LUCK, 40, 4, false, false))).build();
