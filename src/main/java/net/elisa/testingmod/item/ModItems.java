...
public class ModItems {
    ...
    public static final Item BAR_BRAWL_MUSIC_DISC = registerAdvancedItem("bar_brawl_music_disc",
            new Item(getSettings("bar_brawl_music_disc",
                    new Item.Settings().jukeboxPlayable(ModSounds.BAR_BRAWL_KEY).maxCount(1)
            ) ) );
